...
export default class RestorePassword extends React.Component {
  ...
  resetPassword = () => {
    ...
    .then(() => {
      this._alert('Sukces', 'Wysłano email z hasłem', 'Log In', 'LogInStack');
      this.submitAndClear();
    }).catch((error) => {
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.titlePage}>Resetuj hasło</Text>
